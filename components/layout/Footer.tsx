        ...
        <div className="md:col-span-5">
          <div className="flex items-center gap-3 font-bold text-lg mb-4">
            ...
            <span className="leading-tight">
              ...
              <span className="block text-[11px] font-medium tracking-wider uppercase text-white/55">
                {BUSINESS.tagline}
              </span>
            </span>
          </div>
          <p className="text-white/65 text-sm leading-relaxed max-w-sm">
            Family-run garage door sales, installation and repair across
            Maryland. You talk to {BUSINESS.owner}, get a straight price, and
        ...
        <div className="md:col-span-4">
          ...
          <ul className="space-y-3 text-sm text-white/75">
            <li className="flex items-center gap-3">
              ...
              <a href={CONTACT_LINKS.phone} className="hover:text-gold transition-colors">
